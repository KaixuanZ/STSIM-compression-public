...
def sp0Filters(device):
    ''' Steerable pyramid filters.  Transform described  in:
        ...
        @INPROCEEDINGS{Karasaridis96,
            ...
            MONTH = "May",	YEAR = 1996 }  '''
    filters = {}
    filters['harmonics'] = torch.tensor([0])
    filters['lo0filt'] =  (
        torch.tensor([[-4.514000e-04, -1.137100e-04, -3.725800e-04, -3.743860e-03,
                  ...
                  [-4.514000e-04, -1.137100e-04, -3.725800e-04, -3.743860e-03,
                    -3.725800e-04, -1.137100e-04, -4.514000e-04]]) )
    filters['lofilt'] = (
        torch.tensor([[-2.257000e-04, -8.064400e-04, -5.686000e-05, 8.741400e-04,
                  ...
                  [-2.257000e-04, -8.064400e-04, -5.686000e-05, 8.741400e-04,
                   -1.862800e-04, -1.031640e-03, -1.871920e-03, -1.031640e-03,
                    -1.862800e-04, 8.741400e-04, -5.686000e-05, -8.064400e-04,
                    -2.257000e-04]]) )
    filters['mtx'] = torch.tensor([ 1.000000 ])
    filters['hi0filt'] = (
        torch.tensor([[5.997200e-04, -6.068000e-05, -3.324900e-04, -3.325600e-04,
                  ...
                  [5.997200e-04, -6.068000e-05, -3.324900e-04, -3.325600e-04,
                   ...
                   5.997200e-04]]) )
    filters['bfilts'] = (
        torch.tensor([-9.066000e-05, -1.738640e-03, -4.942500e-03, -7.889390e-03,
    ...
    filters['bfilts'] = torch.unbind(filters['bfilts'].reshape(1,1,9,9,1), dim = -1)
    return filters